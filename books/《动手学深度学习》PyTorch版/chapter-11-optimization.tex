...
% BOOKFIG-BEGIN pacman.pdf
\bookfig{pacman.pdf}{11.2.1}{第一组是非凸的，另外两组是凸的。}{见图中标注；各块含义见题注。}
% BOOKFIG-END pacman.pdf

% BOOKFIG-BEGIN convex-intersect.pdf
\bookfig{convex-intersect.pdf}{11.2.2}{两个凸集的交集是凸的。}{见图中标注；各块含义见题注。}
% BOOKFIG-END convex-intersect.pdf

% BOOKFIG-BEGIN nonconvex.pdf
\bookfig{nonconvex.pdf}{11.2.3}{两个凸集的并集不一定是凸的。}{见图中标注；各块含义见题注。}
% BOOKFIG-END nonconvex.pdf

% BOOKFIG-BEGIN projections.pdf
\bookfig{projections.pdf}{11.2.4}{Convex Projections.}{见图中标注；各块含义见题注。}
% BOOKFIG-END projections.pdf
