...
% BOOKFIG-BEGIN finetune.pdf
\bookfig{finetune.pdf}{13.2.1}{微调。}{源域预训练权重；目标域：替换输出层后继续训练}
% BOOKFIG-END finetune.pdf
...
% BOOKFIG-BEGIN iou.pdf
\bookfig{iou.pdf}{13.4.1}{交并比是两个边界框相交面积与相并面积之比。}{见图中标注；各块含义见题注。}
% BOOKFIG-END iou.pdf

% BOOKFIG-BEGIN anchor-label.pdf
\bookfig{anchor-label.pdf}{13.4.2}{将真实边界框分配给锚框。}{见图中标注；各块含义见题注。}
% BOOKFIG-END anchor-label.pdf
...
% BOOKFIG-BEGIN ssd.pdf
\bookfig{ssd.pdf}{13.7.1}{单发多框检测模型主要由一个基础网络块和若干多尺度特征块串联而成。}{多尺度特征图：预测不同大小目标的类别与框}
% BOOKFIG-END ssd.pdf
...
% BOOKFIG-BEGIN r-cnn.pdf
\bookfig{r-cnn.pdf}{13.8.1}{R-CNN模型}{见图中标注；各块含义见题注。}
% BOOKFIG-END r-cnn.pdf

% BOOKFIG-BEGIN fast-rcnn.pdf
\bookfig{fast-rcnn.pdf}{13.8.2}{Fast R-CNN模型}{见图中标注；各块含义见题注。}
% BOOKFIG-END fast-rcnn.pdf

% BOOKFIG-BEGIN roi.pdf
\bookfig{roi.pdf}{13.8.3}{一个 $2\times 2$ 的兴趣区域汇聚层}{见图中标注；各块含义见题注。}
% BOOKFIG-END roi.pdf

% BOOKFIG-BEGIN faster-rcnn.pdf
\bookfig{faster-rcnn.pdf}{13.8.4}{Faster R-CNN 模型}{见图中标注；各块含义见题注。}
% BOOKFIG-END faster-rcnn.pdf

% BOOKFIG-BEGIN mask-rcnn.pdf
\bookfig{mask-rcnn.pdf}{13.8.5}{Mask R-CNN 模型}{见图中标注；各块含义见题注。}
% BOOKFIG-END mask-rcnn.pdf
...
% BOOKFIG-BEGIN segmentation.pdf
\bookfig{segmentation.pdf}{13.9.1}{语义分割中图像有关狗、猫和背景的标签}{见图中标注；各块含义见题注。}
% BOOKFIG-END segmentation.pdf
...
% BOOKFIG-BEGIN trans_conv.pdf
\bookfig{trans_conv.pdf}{13.10.1}{卷积核为 $2\times 2$ 的转置卷积。阴影部分是中间张量的一部分，也是用于计算的输入和卷积核张量元素。}{见图中标注；各块含义见题注。}
% BOOKFIG-END trans_conv.pdf

% BOOKFIG-BEGIN trans_conv_stride2.pdf
\bookfig{trans_conv_stride2.pdf}{13.10.2}{卷积核为$2\times 2$，步幅为2的转置卷积。阴影部分是中间张量的一部分，也是用于计算的输入和卷积核张量元素。}{见图中标注；各块含义见题注。}
% BOOKFIG-END trans_conv_stride2.pdf
...
% BOOKFIG-BEGIN fcn.pdf
\bookfig{fcn.pdf}{13.11.1}{全卷积网络}{卷积骨干：特征；转置卷积：上采样到像素类别}
% BOOKFIG-END fcn.pdf
...
% BOOKFIG-BEGIN style-transfer.pdf
\bookfig{style-transfer.pdf}{13.12.1}{输入内容图像和风格图像，输出风格迁移后的合成图像}{见图中标注；各块含义见题注。}
% BOOKFIG-END style-transfer.pdf

% BOOKFIG-BEGIN neural-style.pdf
\bookfig{neural-style.pdf}{13.12.2}{基于卷积神经网络的风格迁移。实线箭头和虚线箭头分别表示前向传播和反向传播}{见图中标注；各块含义见题注。}
% BOOKFIG-END neural-style.pdf
